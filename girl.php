        ...
        .search-bar i {
         ...
         <div class="header-icons">
                ...
                <div class="nav-bar">
                    ...
                    <a href="girl.php" class="active">Girls</a>
...
$filters = [];
$sql = "SELECT * FROM product WHERE categories_id = 1"; // Only products with categories_id = 1
...
if (isset($_POST['search']) && !empty($_POST['query'])) {
    ...
    $sql = "SELECT p.* FROM product p 
            WHERE p.categories_id = 1";  // Ensure products belong to category 1
