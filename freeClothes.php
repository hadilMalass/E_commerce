        ...
        .search-bar i {
         ...
         <div class="header-icons">
                ...
                <div class="nav-bar">
                    ...
                    <a href="freeClothes.php" class="active">Free Clothes</a>
                    <!-- <a href="#">Donation</a> -->
                </div>
...
<div class="donation-container">
        <p>Free Clothes: Girl, Boy, Sport Wear <br> For Donation:</p>
        <a href="donation.php" class="donation-button">Click Here</a>
    </div>
</body>  
<style>
...
$filters = [];
$sql = "SELECT * FROM product WHERE categories_id = 5"; // Only products with categories_id = 1
...
if (isset($_POST['search']) && !empty($_POST['query'])) {
    ...
    $sql = "SELECT p.* FROM product p 
            WHERE p.categories_id = 5";  // Ensure products belong to category 1
