        ...
        .search-bar i {
         ...
         <div class="header-icons">
                ...
                <div class="nav-bar">
                    ...
                    <a href="sportWear.php"class="active">SportWear</a>
...
$filters = [];
$sql = "SELECT * FROM product WHERE categories_id = 3"; // Only products with categories_id = 1
...
if (isset($_POST['search']) && !empty($_POST['query'])) {
    ...
    $sql = "SELECT p.* FROM product p 
            WHERE p.categories_id = 3";  // Ensure products belong to category 1
